...
import { categories } from "@/lib/verticals";
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="mx-auto max-w-7xl px-6 pt-8">
        ...
        <p className="text-muted-foreground mt-1">{isLoading ? "Loading…" : `${filtered.length} kitchens delivering near you`}</p>
        ...
        <div className="mt-6 flex flex-col md:flex-row gap-3">
          ...
          <div className="flex items-center gap-2 px-3 py-2 rounded-xl bg-card border border-border">
            ...
            <select value={sort} onChange={(e) => setSort(e.target.value as typeof sort)} className="bg-transparent text-sm focus:outline-none">
